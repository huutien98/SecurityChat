...
import com.example.securitychat.databinding.ActivityPhoneLoginBinding;
...
public class PhoneLoginActivity extends AppCompatActivity
{
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                         ...
                         //  users.setUserId(user.getUid());
                            users.setPhone(user.getPhoneNumber().toString());

                            database.getReference().child("Users").child(user.getPhoneNumber()).setValue(users);
    ...
    {
        Toast.makeText(PhoneLoginActivity.this, "vui lòng thêm tên đưng nhập",Toast.LENGTH_SHORT ).show();
